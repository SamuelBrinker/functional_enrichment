...
SERVICE_CAPS = samuelbrinkerfunctional_enrichment_update
SPEC_FILE = samuelbrinkerfunctional_enrichment_update.spec
URL = https://kbase.us/services/samuelbrinkerfunctional_enrichment_update
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
